...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for antlr4 (org.antlr:antlr4)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAntlr4() {
            return create("antlr4");
    }
    ...
    public static class BuildLibraryAccessors extends SubDependencyFactory {
        private final BuildInfoLibraryAccessors laccForBuildInfoLibraryAccessors = new BuildInfoLibraryAccessors(owner);

        public BuildLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at build.info
         */
        public BuildInfoLibraryAccessors getInfo() {
            return laccForBuildInfoLibraryAccessors;
        }

    }

    public static class BuildInfoLibraryAccessors extends SubDependencyFactory {
        private final BuildInfoExtractorLibraryAccessors laccForBuildInfoExtractorLibraryAccessors = new BuildInfoExtractorLibraryAccessors(owner);

        public BuildInfoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at build.info.extractor
         */
        public BuildInfoExtractorLibraryAccessors getExtractor() {
            return laccForBuildInfoExtractorLibraryAccessors;
        }

    }

    public static class BuildInfoExtractorLibraryAccessors extends SubDependencyFactory {

        public BuildInfoExtractorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for gradle (org.jfrog.buildinfo:build-info-extractor-gradle)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getGradle() {
                return create("build.info.extractor.gradle");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final BuildVersionAccessors vaccForBuildVersionAccessors = new BuildVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: antlr4 (4.12.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: gson (2.10)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.build
         */
        public BuildVersionAccessors getBuild() {
            return vaccForBuildVersionAccessors;
        }
    ...
    public static class BuildVersionAccessors extends VersionFactory  {

        private final BuildInfoVersionAccessors vaccForBuildInfoVersionAccessors = new BuildInfoVersionAccessors(providers, config);
        public BuildVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.build.info
         */
        public BuildInfoVersionAccessors getInfo() {
            return vaccForBuildInfoVersionAccessors;
        }

    }

    public static class BuildInfoVersionAccessors extends VersionFactory  {

        private final BuildInfoExtractorVersionAccessors vaccForBuildInfoExtractorVersionAccessors = new BuildInfoExtractorVersionAccessors(providers, config);
        public BuildInfoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.build.info.extractor
         */
        public BuildInfoExtractorVersionAccessors getExtractor() {
            return vaccForBuildInfoExtractorVersionAccessors;
        }

    }

    public static class BuildInfoExtractorVersionAccessors extends VersionFactory  {

        public BuildInfoExtractorVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: build.info.extractor.gradle (4.23.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGradle() { return getVersion("build.info.extractor.gradle"); }
    ...
    public static class JunitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Returns the group of versions at versions.junit.vintage
         */
    ...
    public static class JunitJupiterVersionAccessors extends VersionFactory  {
        ...
        public JunitJupiterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: junit.jupiter.engine (5.9.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class JunitPlatformVersionAccessors extends VersionFactory  {
        ...
        public JunitPlatformVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: junit.platform.runner (1.9.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRunner() { return getVersion("junit.platform.runner"); }
    ...
    public static class JunitVintageVersionAccessors extends VersionFactory  {
        ...
        public JunitVintageVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: junit.vintage.engine (5.9.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
         ...
         */
        public KotlinGradleVersionAccessors getGradle() {
            return vaccForKotlinGradleVersionAccessors;
        }
    ...
    public static class KotlinGradleVersionAccessors extends VersionFactory  {
        ...
        public KotlinGradleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlin.gradle.plugin (1.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
